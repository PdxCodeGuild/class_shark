...
print(f"\nIf you play the lottery {pretty_play} times, it will cost you {pretty_cost} dollars and you will make {pretty_games} dollars in return. Your net investment will be {net_investment}.")