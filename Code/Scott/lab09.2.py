...
Name:           Scott Tran
Date            6/7/2019
Assignment:     Write program that allows the user to convert a number between units. Allow the user to also enter the units. Then depending on the units, convert the distance into meters. The units we'll allow are feet, miles, meters, and kilometers.
"""
